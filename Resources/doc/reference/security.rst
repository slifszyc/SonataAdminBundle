...
The ``sonata.admin.security.handler.role`` allows you to operate finely on the actions that can be done (depeding on the entity class), without requiring to set up ACL.
